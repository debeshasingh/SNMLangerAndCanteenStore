...
public class CanteenActivity extends AppCompatActivity implements HelperInterface {
    ...
    public void vendorList() {
        ...
        Fragment fragment = CanteenListFragment.newInstance();
        fragmentTransaction.add(R.id.frame_canteen, fragment, AppConstants.FRAGMENT_CANTEEN_LIST);
        fragmentTransaction.addToBackStack(AppConstants.FRAGMENT_CANTEEN_LIST);
