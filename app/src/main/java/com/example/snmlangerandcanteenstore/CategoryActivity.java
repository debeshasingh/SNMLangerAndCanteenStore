...
import com.example.snmlangerandcanteenstore.fragment.category.CategoryListFragment;
...
public class CategoryActivity extends AppCompatActivity implements HelperInterface {
    ...
    public void vendorList() {
        ...
        fragmentTransaction.add(R.id.frame_category, fragment, AppConstants.FRAGMENT_CATEGORY_LIST);
        fragmentTransaction.addToBackStack(AppConstants.FRAGMENT_CATEGORY_LIST);
